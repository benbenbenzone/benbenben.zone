...
var _ben = require('../assets/ben.svg');
...
var _class = function () {
  ...
  _createClass(_class, [{
    ...
    value: function load() {
      ...
      paper.project.importSVG(_ben2.default, {
        insert: false,
        onLoad: function onLoad(item) {

          _this.benSingle = new CompoundPath({
            children: [item.children[1].children[0].children[0], item.children[1].children[0].children[1], item.children[1].children[0].children[2]],
            insert: false
          });
          var ben1 = _this.benSingle.clone();
          console.log(ben1.bounds);
          ben1.position.x -= ben1.bounds.width + 15;
          var ben2 = _this.benSingle.clone();
          ben2.position.x += ben2.bounds.width + 15;
          _this.ben = new CompoundPath({
            children: [ben1, _this.benSingle, ben2],
            insert: false
          });
          _this.ben.fillColor = 'red';
          _this.ben.scale(5.0, 25.0);
          _this.ben.position = view.center;
          console.log(_this.ben.children);

          // this.ben.selected = true;
          _this.ben.addTo(paper.project);
          _this.benStatic = _this.ben.clone({ insert: false });
        }
      });
    }
  }, {
    ...
    key: 'updateBens',
    value: function updateBens(time) {
...
},{"paper":14,"../assets/ben.svg":13}],7:[function(require,module,exports) {
'use strict';
...
var _rightNow = require('right-now');

var _rightNow2 = _interopRequireDefault(_rightNow);

var _benBlend = require('./animations/ben-blend');

var _benBlend2 = _interopRequireDefault(_benBlend);
...
var animationsImportList = [_benBlend2.default];
...
var _class = function () {
  function _class() {
    ...
    this._lastTime = (0, _rightNow2.default)();
    this.time = 0;
  ...
  _createClass(_class, [{
    ...
    value: function load() {
      ...
      animationsImportList.forEach(function (AnimationImport) {
        _this.animations.push(new AnimationImport(_this.canvas));
      });
    ...
    value: function _animate() {
      ...
      var now = (0, _rightNow2.default)();
      var dt = Math.min(this.maxDeltaTime, (now - this._lastTime) / 1000);
      this.time += dt;
      this._lastTime = now;
    ...
    key: '_update',
    value: function _update(dt, time) {
      this.animations.forEach(function (animation) {
        animation.update({
          dt: dt,
          time: time
...
exports.default = _class;
},{"right-now":11,"./animations/ben-blend":9}],3:[function(require,module,exports) {
'use strict';
...
window.onload = function () {
  ...
  conductor.load().then(function () {
    conductor.start();
  });
};
},{"./conductor":7}],18:[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/src.8901c5d6.map